...
public class DbProductRepositotyImplementation implements ProductRepository {
    ...
    public void renew(int id, Product object) throws IllegalArgumentException {
        try {
            manager.executeUpdate("UPDATE product SET " + "idProduct=" + id + ", name='" + object.getName() + "', price=" + object.getPrice() + ", idDepartment=" + object.getDepartmentId() + " " + "WHERE idProduct=" + id);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    }
